...
async function showBubbleChart(htmlParentId, pmyear) {
  ...
  d3.csv(cvsfile, function (data) {
    ...
    if (pmyear == -1) {
      ...
      data = data.filter(function(d){ return d.released_year == pmyear })
    }
    ...
    var showTooltip = function (d) {
      ...
      tooltip
        .style("opacity", 1)
        .html("Track: " + d.track_name + "<br> Artist: " + d.artist_name + "<br> Stream: " + d.streams/1000000 + "M")
    ...
    // ---------------------------//
      ...
      svg.append("text")
        ...
        var showTooltipHighRect = function (d) {
          ...
          tooltip
            .style("opacity", 1)
            .html(" Tracks with High Danceability and Valence")
            .style("left", (d3.mouse(this)[0] + 30) + "px")
            .style("top", (d3.mouse(this)[1] + 30) + "px")
        }
      drawHighRect(svg, showTooltipHighRect, moveTooltip, hideTooltip, 700, 10, 250,250);
    ...
    svg.append('g')
      ...
      .append("circle")
      .attr("class", "bubbles")
      .attr("cx", function (d) { return x(d.valence_pct); })
      .attr("cy", function (d) { return y(d.Danceability_pct); })
      .attr("r", function (d) { return z(d.streams/2); })
      .style("fill", function (d) { return myColor(d.artist_name); })
